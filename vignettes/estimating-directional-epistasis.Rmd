...
You data have to follow the same format. If the full reciprocal crosses have not been done, the means and standard error of the missing derivative populations have to be NA, like in the example below. 
